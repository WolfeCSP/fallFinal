...
def test_concatFirstAndLastNames():
    assert concatFirstAndLastNames(first_names1,last_names2) == ['Peter Parker', 'Tony Stark', 'Steve Rogers', 'Natasha Romanoff', 'Bruce Banner', 'Thor Odinson', 'Wanda Maximoff', 'Scott Lang', 'Stephen Strange']
